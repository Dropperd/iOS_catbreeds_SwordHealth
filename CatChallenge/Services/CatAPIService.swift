...
final class CatAPIService {
    ...
    func fetchBreeds() async throws -> [CatBreedDTO] {
        guard let url = URL(string: "\(baseURL)/breeds") else { throw CatAPIError.invalidURL }
    ...
    // Parse life_span strings incorrect format "10 - 12"
